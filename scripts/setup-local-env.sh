...
#   - Generates .envrc (gitignored) so direnv scopes secrets + venv to this directory only
...

{
    ...
    echo ""
    echo "# Activate the project Python venv (provides ansible-vault, ansible-playbook, etc.)"
