...
<img src="/assets/images/blog/linux-curl-wget-making-requests-to-endpoints/curl-pro-tip.jpg" alt="Copying curl command from the browser network tab" class="mx-auto" loading="lazy"/>
