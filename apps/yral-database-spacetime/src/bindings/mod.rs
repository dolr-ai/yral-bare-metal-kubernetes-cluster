...
pub use rename_character_reducer::rename_character;
...
impl __sdk::Reducer for Reducer {
    ...
    fn args_bsatn(&self) -> Result<Vec<u8>, __sats::bsatn::EncodeError> {
        match self {
            ...
            Reducer::LevelUpCharacter => {
                __sats::bsatn::to_vec(&level_up_character_reducer::LevelUpCharacterArgs {})
            }
            Reducer::RenameCharacter { new_name } => {
                __sats::bsatn::to_vec(&rename_character_reducer::RenameCharacterArgs {
