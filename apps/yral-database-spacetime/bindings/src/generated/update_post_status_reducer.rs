...
#[sats(crate = __lib)]
pub(super) struct UpdatePostStatusArgs {
    pub post_id: String,
    pub status: PostStatus,
}

impl From<UpdatePostStatusArgs> for super::Reducer {
    fn from(args: UpdatePostStatusArgs) -> Self {
...
/// Extension trait for access to the reducer `update_post_status`.
///
/// Implemented for [`super::RemoteReducers`].
pub trait update_post_status {
...
impl update_post_status for super::RemoteReducers {
    fn update_post_status_then(
        &self,
        post_id: String,
        status: PostStatus,
